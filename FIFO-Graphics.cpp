...
{
	settextstyle(8,0,4);
	outtextxy(60,20,"FIFO page replacement algorithm");
...
int main()
{
    ...
    int choice;
	printf("\n*\n\tEnter '1' :Create an array: 7, 0, 1, 2, 0, 3, 0, 4, 2, 3, 0, 3, 2, 1, 2, 0, 1, 7, 0\n");
	printf(" \n\tEnter '2' :Custom\n");
	...
	switch (choice)
	{
        ...
        {
        	int np = 20;
            int page[np]={7, 0, 1, 2, 0, 3, 0, 4, 2, 3, 0, 3, 2, 1, 2, 0, 1, 7, 0};
